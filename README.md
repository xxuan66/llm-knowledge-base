...
- ✅ Tokenizer 实现：新增 Tokenizer 训练工作流（BPE/WordPiece/Unigram）
- ✅ Tokenizer 实现：新增 Tokenizer 评估脚本
- ✅ 预训练流程：新增数据准备自动化脚本
- ✅ 预训练流程：新增预训练配置模板和启动脚本

## 🆕 2026-03-30 更新（第二批）

- ✅ 对话机器人：新增 5 个场景配置模板（客服、技术文档、创意写作、数据分析、面试模拟）
- ✅ 知识库问答：新增 4 个场景配置（企业知识库、技术文档、客服、学术论文）
- ✅ 添加场景配置对比表和最佳实践建议
